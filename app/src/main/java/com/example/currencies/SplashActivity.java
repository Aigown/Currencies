...
public class SplashActivity extends AppCompatActivity {
    public static final String URL_CODES = "https://openexchangerates.org/api/currencies.json?app_id=abc6652028f3483e9d5cc118279eb49b";
    ...
    private class FetchCodesTask extends AsyncTask<String, Void, JSONObject> {
        ...
        protected void onPostExecute(JSONObject jsonObject) {
            try {
                ...
                Toast.makeText(
                        SplashActivity.this,"There's been a JSON exception: " + e.getMessage(),Toast.LENGTH_LONG
